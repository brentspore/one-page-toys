...
const TYPE_NL_PHRASES = {
  ...
  "golden-hour":
    "golden hour blue hour magic hour sunrise sunset sun times sun calculator sunrise sunset calculator when is sunset today when is sunrise what time is golden hour photography light photographer planner photo shoot planner portrait light warm light soft light twilight civil twilight dusk dawn first light last light day length hours of daylight longest day shortest day solstice sun position sun altitude sun angle solar noon light ribbon shoot planner videographer film light sun tracker suncalc utility tool",
  "barkeep":
    "barkeep bartender cocktail cocktails cocktail recipes drink recipes mixed drinks what cocktails can i make what can i make with what i have cocktails by ingredient ingredient search my bar home bar bar cart liquor cabinet bottles on my shelf what to buy next best bottle to buy mixology mixologist bartending how to make a negroni old fashioned margarita mojito martini manhattan daiquiri whiskey sour espresso martini aperol spritz moscow mule cosmopolitan pina colada mai tai gin cocktails vodka cocktails rum cocktails tequila cocktails mezcal whiskey bourbon cocktails classic cocktails iba cocktails mocktails zero proof non alcoholic drinks happy hour party drinks date night oz to ml jigger shaken or stirred garnish glassware coupe highball rocks glass recipe book cocktail app cocktail finder drink finder utility tool",
  "moon-phase":
    "moon phase moon phase tonight what phase is the moon what is the moon tonight lunar phase moon calendar lunar calendar full moon new moon first quarter last quarter waxing crescent waning crescent waxing gibbous waning gibbous moon age moon illumination percent lit next full moon when is the full moon harvest moon hunter moon wolf moon strawberry moon sturgeon moon blue moon supermoon moon distance perigee apogee lunar cycle synodic month astronomy stargazing night sky moon watching moon on my birthday moon tracker maria craters tycho sea of tranquility utility tool",
  "accretion":
  ...
  "alpenglow":
    "alpenglow alto altos adventure odyssey snowboarding snowboarder sandboarding ski skiing tiny wings ski safari endless runner backflip flips tricks grind rails grinding combo multiplier one touch one button hold to flip scarf mountain dusk sunset sunrise day night cycle weather snowfall blizzard thunderstorm cozy flow zen serene beautiful atmospheric silhouette trick game line rider chill",
  "sky-fortress":
